...
function Banner() {
    return (
        <section className='banner px-4 px-lg-0'>
            <Container fluid="lg">
                <div className="banner_main d-flex flex-wrap flex-md-nowrap">
                    <div className="left_banner col-12 col-md-6 position-relative">
                        ...
                        <div className="text_box position-absolute top-0 start-0 d-flex flex-column align-items-start ps-4 ps-sm-5 pt-sm-5">
                            ...
                            <h2 className='text-white mt-2 text-start fs-5 fs-md-4 fs-1'>Modern Mini Couch</h2>
                    ...
                    <div className="right_banner col-12 col-md-6">
                        <div className="right_up position-relative col">
                            ...
                            <div className="text_box position-absolute top-0 start-0 d-flex flex-column align-items-start ps-4 ps-sm-5 ps-md-4 pt-4 pt-sm-5 pt-md-4 pt-lg-5 ps-lg-5">
                                <h2 className='text-black mt-2 text-start text-capitalize  fs-5 fs-md-4 fs-2'>plant pots <br />
                        ...
                        <div className="right_down position-relative">
                            ...
                            <div className="text_box position-absolute top-0 start-0 d-flex flex-column align-items-start ps-4 ps-sm-5 ps-md-4 pt-4 pt-sm-2 pt-md-0 pt-lg-5 ps-lg-5">
                                <span className='text-uppercase fw-medium text-white pt-1 fs-6 fs-sm-5'>NEW ARRIVALS</span>
                                <h2 className='text-white mt-2 text-start fs-6 fs-md-4 fs-1'>Romina <br />
                                    Table Lamp</h2>
